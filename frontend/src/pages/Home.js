  ...
  return (
    <Fragment>
      ...
      <FieldsRow>
        ...
        <Button>
          <Card sx={{ width: 400, height: 300 }}>
            ...
            />
            <CardContent>
              <Typography sx={dateStyle}>20 Oct 2023 (Fri)</Typography>
        ...
        <Button>
          <Card sx={{ width: 400, height: 300 }}>
            <CardMedia component="img" height="175" image={Twice} alt="Twice" />
            <CardContent>
              <Typography sx={dateStyle}>
      ...
      <FieldsRow>
        <Button>
          <Card sx={{ width: 400, height: 300 }}>
            <CardMedia component="img" height="175" image={Ateez} alt="Ateez" />
            <CardContent>
              <Typography sx={dateStyle}>9 Sep 2023 (Sat)</Typography>
              <Typography sx={eventStyle}>
        ...
        <Button>
          <Card sx={{ width: 400, height: 300 }}>
            <CardMedia component="img" height="175" image={Lauv} alt="Lauv" />
            <CardContent>
              <Typography sx={dateStyle}>5 Sep 2023 (Tue)</Typography>
              <Typography sx={eventStyle}>
        ...
        <Button>
          <Card sx={{ width: 400, height: 300 }}>
            ...
            />
            <CardContent>
              <Typography sx={dateStyle}>17 Sep 2023 (Sun)</Typography>
              <Typography sx={eventStyle}>
      ...
      <FieldsRow>
        <Button>
          <Card sx={{ width: 400, height: 300 }}>
            ...
            />
            <CardContent>
              <Typography sx={dateStyle}>12 Nov 2023 (Sun)</Typography>
              <Typography sx={eventStyle}>
        ...
        <Button>
          <Card sx={{ width: 400, height: 300 }}>
            ...
            />
            <CardContent>
              <Typography sx={dateStyle}>17 Oct 2023 (Tue)</Typography>
              <Typography sx={eventStyle}>
